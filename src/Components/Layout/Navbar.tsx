  ...
  return (
    <div className="flex justify-between border-b w-full p-4">
      ...
      <div className="flex items-center ">
        <button className="flex items-center border-solid border-2 border-black-600 rounded-3xl pb-0.5 pt-0.5 pr-2 pl-2 border">
          {" "}
          <svg
          ...
          <button className="ml-1 text-sm">Create</button>
        </button>
